...
- Live API evidence: the protected [manual live API contract run](https://github.com/rodion981/ha-netbird/actions/runs/36159603786/job/108170984157) passed on 25 September 2026 for the complete v0.2.0 account, peer, network, resource, router, and peer-group shape. This is point-in-time shape evidence only.
...
- NetBird [describes its API error handling as beta](https://docs.netbird.io/api/guides/errors). An HTTP 404 alone does not establish PAT expiry. Cloud API surfaces may evolve. Anonymized fixtures and mocked responses verify code behavior; the protected [manual live run](https://github.com/rodion981/ha-netbird/actions/runs/36159603786/job/108170984157) separately established point-in-time shape evidence for the complete v0.2.0 endpoint set. Record future live findings separately with date, API documentation version or URL, anonymized shape, tested scope, and outcome. Never record raw production responses or identifiers.
